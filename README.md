...
| [`scientific-writing`](skills/scientific-writing/) | Drafting or revising a manuscript. Continuous prose instead of bold mini-headings, subsections ordered by the argument rather than by the analysis, numerical density, redundancy, claims calibrated in both directions, and LaTeX that encodes structure instead of decorating it. |
...
| [`statistical-analysis`](skills/statistical-analysis/) | Whether the inference is valid: the unit of analysis, the estimand, effect sizes, multiplicity, sensitivity. Ships a checker for the reporting defects a script can settle, including a percentage no whole number out of its denominator could produce. |
